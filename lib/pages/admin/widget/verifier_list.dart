...
class VerifierList extends StatefulWidget {
  const VerifierList({Key? key}) : super(key: key);

  @override
  State<VerifierList> createState() => _VerifierListState();
}

class _VerifierListState extends State<VerifierList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Verifier List"),
        ),
